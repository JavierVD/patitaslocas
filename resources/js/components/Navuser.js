            ...
            <div align="center">
                <nav>
                    <div className="ColorNav logo-nav-cont">
                        ...
                        <ul className="uln" >
                            <li className="uli"><a href="home" className="Menu">Inicio</a></li>
                            ...
                            <li className="uli"><a href="https://crmpatitasfelices.azurewebsites.net" className="Menu">Abrir CRM</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
